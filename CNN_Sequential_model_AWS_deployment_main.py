...
#You need to modify the MODEL_PATH according to your path on your local machine and also change the port in the end instead of port=8080 as your requirements,so please take a note of this.